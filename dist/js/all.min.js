...
!function(){"use strict";angular.module("myApp",["myApp.controllers","myApp.directives"])}(),function(){"use strict";function e(e){e.name={first:"Jane",last:"Doe"}}angular.module("myApp.controllers",[]).controller("helloWorldCtrl",e),e.$inject=["$scope"]}(),function(){"use strict";angular.module("myApp.directives",[]).directive("helloWorld",function(){return{restrict:"AE",scope:{name:"=name"},template:"<h1>Hello {{ name.first }} {{ name.last }}!</h1><input data-ng-model='name.first'></input><input data-ng-model='name.last'></input>"}})}();